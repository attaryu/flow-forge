...
## Corpus Check
- 10 files · ~41,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1321 nodes · 1868 edges · 107 communities (78 shown, 29 thin omitted)
...
Cohesion: 0.07
Nodes (38): AppSidebar(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+30 more)
...
### Community 6 - "scripts"
Cohesion: 0.05
Nodes (41): @base-ui/react, class-variance-authority, clsx, elkjs, @fontsource-variable/geist, isbot, ky, lucide-react (+33 more)

### Community 7 - "Route Module"
Cohesion: 0.08
Nodes (32): react, Separator(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup() (+24 more)
...
Cohesion: 0.14
Nodes (19): AppSidebarProps, SidebarUser, DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup(), DropdownMenuItem(), DropdownMenuLabel() (+11 more)
...
Cohesion: 0.22
Nodes (5): Badge(), badgeVariants, Input(), Skeleton(), Textarea()
...
## Knowledge Gaps
- **589 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `name`, `version`, `description` (+584 more)
...
- **Why does `react` connect `Route Module` to `FlowForge System Architecture`, `auth.controller.ts`, `scripts`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `cn()` connect `workflows.controller.ts` to `devDependencies`, `welcome.tsx`, `Route Module`, `@nestjs/cli`, `prettier`, `auth.controller.ts`, `cn`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `dependencies` connect `scripts` to `README.md`, `Route Module`?**
