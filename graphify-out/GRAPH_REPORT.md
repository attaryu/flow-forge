...
## Corpus Check
- 10 files · ~51,370 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1541 nodes · 2246 edges · 153 communities (100 shown, 53 thin omitted)
...
- Community 140 (Param)
- Community 141 (Post)
- Community 144 (react-router.config.ts)
- Community 145 (vite.config.ts)
- Community 146 (eslint.config.mjs)
- Community 147 (Post)
- Community 148 (UseGuards)
...
Cohesion: 0.08
Nodes (26): Delete, Patch, Body, Controller, Get, HttpCode, Param, UseGuards (+18 more)
...
Cohesion: 0.13
Nodes (15): CurrentUser, JwtAuthGuard, Injectable, OrganizationsController, Controller, Get, UseGuards, OrganizationResponseDto (+7 more)

### Community 9 - "compilerOptions"
Cohesion: 0.15
Nodes (20): Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, Badge(), badgeVariants, Input() (+12 more)
...
Cohesion: 0.18
Nodes (13): MinLength, AuthResponseDto, LoginInputDto, IsEmail, IsNotEmpty, IsString, RegisterInputDto, IsEmail (+5 more)
...
Cohesion: 0.13
Nodes (6): AuthRepository, Injectable, AuthService, Injectable, OnboardingService, Injectable
...
Cohesion: 0.17
Nodes (12): Controller, CurrentOrgId, CurrentUser, Get, HttpCode, Param, Post, Roles (+4 more)

### Community 24 - "Component Composition Rules"
Cohesion: 0.14
Nodes (9): RunsRepository, Injectable, RunsModule, Module, RunsService, Injectable, InjectQueue, Module (+1 more)
...
Cohesion: 0.12
Nodes (17): @base-ui/react, class-variance-authority, clsx, @fontsource-variable/geist, @monaco-editor/react, @react-router/node, shadcn, dependencies (+9 more)

### Community 29 - "Icon Rules"
Cohesion: 0.14
Nodes (10): Global, AuthModule, Module, JwtPayload, JwtStrategy, Injectable, DurationUtils, Injectable (+2 more)
...
Cohesion: 0.19
Nodes (13): AppSidebar(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+5 more)

### Community 36 - "@eslint/js"
Cohesion: 0.14
Nodes (14): `apply` — Apply a preset to an existing project, `build` — Build a custom registry, Commands, Contents, `diff` — Check for updates, `docs` — Get component documentation URLs, `info` — Project information, `init` — Initialize or create a project (+6 more)
...
Cohesion: 0.31
Nodes (6): Label(), Login(), Register(), queryClient, getUser(), setSession()
...
Cohesion: 0.17
Nodes (12): apply Command, build Command, Built Registry, shadcn CLI, docs Command, info Command, init Command, Preset System (+4 more)

### Community 48 - "ts-node"
Cohesion: 0.32
Nodes (5): Injectable, DashboardStatsDto, RecentRunDto, RunsByDayDto, DashboardService
...
Cohesion: 0.22
Nodes (3): Toaster(), ToasterProps, userQueryOption

### Community 58 - "Mode Migration"
Cohesion: 0.31
Nodes (5): clientAction(), failedQueue, http, clearSession(), User
...
### Community 65 - "Tools"
Cohesion: 0.31
Nodes (7): DashboardStats, dashboardStatsQueryOption(), RecentRun, RunsByDay, useDashboardStats(), DashboardIndex(), iconMap
...
Cohesion: 0.36
Nodes (5): AppModule, Module, DashboardModule, Module, bootstrap()
...
## Knowledge Gaps
- **617 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `name`, `version`, `description` (+612 more)
...
- **Why does `react` connect `Route Module` to `tsconfig-paths`, `Chat and Messaging UI`, `seed.ts`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `dependencies` connect `seed.ts` to `React Router`, `Core Decisions`, `Customizing Components`, `shadcn CLI Reference`, `collapsible.tsx`, `bullmq`, `Route Module`, `graphify-update.py`, `app-sidebar.tsx`, `node-config-panel.tsx`, `organizations.controller.ts`, `settings.tsx`, `cn`, `ioredis`, `@nestjs/common`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `cn()` connect `compilerOptions` to `eslint-config-prettier`, `globals`, `scripts`, `Route Module`, `@nestjs/testing`, `app.module.ts`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
